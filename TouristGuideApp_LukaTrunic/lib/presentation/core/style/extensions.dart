...
import 'package:tourist_guide_app/presentation/core/style/text_styles.dart';
import 'colors.dart';
...
extension StyleExtention on BuildContext {
  ...
  TextStyle get textButton =>
      Theme.of(this).textTheme.buttonTextStyle.copyWith(color: Colors.white);
  ...
  TextStyle get textBelow => Theme.of(this).textTheme.belowTextStyle;
}
